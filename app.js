...
function seedState(){
  return {
    ...
    // ONLY the leader can change this (via the Roadmap page). Weeks 1-3 are
    // already finished, week 4 is current, the rest are upcoming.
    roadmap: [
      ...
      { id:'w2', title:'Week 2', dateRange:'Aug 31 – Sep 6', goal:'Get to know teammates and prepare to select our client company.', deadline:'2026-09-07', status:'done',
        tasks:['Video call to meet the team','Review available client challenges','Discuss role division','Select Amigos Caffè as client'] },
      { id:'w3', title:'Week 3', dateRange:'Sep 7 – Sep 13', goal:'Kick off Section 1: industry & competitor research for Amigos Caffè.', deadline:'2026-09-14', status:'done',
      ...
      { id:'w4', title:'Week 4', dateRange:'Sep 14 – Sep 20', goal:'Finish Section 1 draft and select the proposed target market.', deadline:'2026-09-21', status:'current',
